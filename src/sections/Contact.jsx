          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
            ...
            <div className="glass rounded-3xl p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-sm">
                ...
                collaborative opportunities. If you&apos;re looking for a
                motivated developer who enjoys building modern web applications
                and continuously learning new technologies, I&apos;d love to
                connect.
              </p>
            </div>
          </div>
